...
x_files = ['data/train_x_cool.csv', 'data/train_x_demo.csv', 'data/train_x_hot.csv', 'data/train_x_mixed.csv']
y_files = ['data/train_y_cool.csv', 'data/train_y_demo.csv', 'data/train_y_hot.csv', 'data/train_y_mixed.csv']
...
port_angeles_summer_x, port_angeles_summer_y = pd.read_csv(x_files[0])[17472:], pd.read_csv(y_files[0])[17472:]
pittsburgh_winter_x, pittsburgh_winter_y = pd.read_csv(x_files[1]), pd.read_csv(y_files[1])
pittsburgh_summer_x, pittsburgh_summer_y = pd.read_csv(x_files[1])[17472:], pd.read_csv(y_files[1])[17472:]
tucson_winter_x, tucson_winter_y = pd.read_csv(x_files[2]), pd.read_csv(y_files[2])
tucson_summer_x, tucson_summer_y = pd.read_csv(x_files[2])[17472:], pd.read_csv(y_files[2])[17472:]
new_york_winter_x, new_york_winter_y = pd.read_csv(x_files[3]), pd.read_csv(y_files[3])
new_york_summer_x, new_york_summer_y = pd.read_csv(x_files[3])[17472:], pd.read_csv(y_files[3])[17472:]
